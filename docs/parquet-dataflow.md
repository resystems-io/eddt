...
- [Architecture Mandate](#architecture-mandate)
- [Background and Motivation](#background-and-motivation)
  - [1. Unified Egress Routing ("Write Once, Route Anywhere")](#1-unified-egress-routing-write-once-route-anywhere)
  - [2. Abstraction of the Low-Level Parquet API](#2-abstraction-of-the-low-level-parquet-api)
  - [3. Automatic Union Translation](#3-automatic-union-translation)
