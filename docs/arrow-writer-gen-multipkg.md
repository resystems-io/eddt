...
- [Overview](#overview)
- [CLI Flags](#cli-flags)
  - [`--pkg` / `-p` (repeatable, default `["."]`)](#--pkg--p-repeatable-default)
  - [`--pkg-alias` / `-a` (repeatable, optional)](#--pkg-alias--a-repeatable-optional)
  - [`--structs` / `-s` (required)](#--structs--s-required)
  - [`--pkg-name` / `-n` (optional)](#--pkg-name--n-optional)
  - [`--out` / `-o` (default `arrow-writer-gen.go`)](#--out--o-default-arrow-writer-gengo)
- [Example CLI Invocations](#example-cli-invocations)
  - [Single package (backward-compatible)](#single-package-backward-compatible)
  - [Two packages — Outer references Inner from a sibling package](#two-packages-outer-references-inner-from-a-sibling-package)
  - [Alias to avoid name collisions](#alias-to-avoid-name-collisions)
  - [Mixed: native cross-package structs + external marshal fallback](#mixed-native-cross-package-structs-external-marshal-fallback)
- [Resolution Decision Tree](#resolution-decision-tree)
