...
const writerTemplateStr = `// Code generated by arrow-writer-gen{{if .Version}} ({{.Version}}){{end}}. DO NOT EDIT.
package {{.PackageName}}
{{- if .ElidedSchemas}}
