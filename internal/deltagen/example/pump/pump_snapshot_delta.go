// Code generated by delta-gen (eb1a7c95). DO NOT EDIT.
package pump
...
// package-level ApplyPumpSnapshot function (R-DG-012, R-DG-013, R-DG-019).
func (s PumpSnapshot) Apply(d PumpSnapshotDelta) (PumpSnapshot, error) {
	return ApplyPumpSnapshot(s, d)
}

// DiffPumpSnapshot produces the minimal Delta d such that ApplyPumpSnapshot(a, d) payload-equals b.
// It is a pure function; chain-envelope validations live in
...
// package-level DiffPumpSnapshot function (R-DG-012, R-DG-013, R-DG-019).
func (a PumpSnapshot) Diff(b PumpSnapshot) (PumpSnapshotDelta, error) {
	return DiffPumpSnapshot(a, b)
}

// CoalescePumpSnapshot folds a slice of TDeltas into s by iterated ApplyPumpSnapshot. It is a pure
// function; chain-envelope validations propagate from the first failing ApplyPumpSnapshot
...
// package-level CoalescePumpSnapshot function (R-DG-012, R-DG-013, R-DG-019).
func (s PumpSnapshot) Coalesce(ds []PumpSnapshotDelta) (PumpSnapshot, error) {
	return CoalescePumpSnapshot(s, ds)
}

// EntityIDPumpSnapshot creates a hash for the key field: SerialNumber
//
